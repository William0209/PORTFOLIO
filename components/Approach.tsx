...
const Approach = () => {
  return (
    <section className="w-full py-20 mt-[10rem]">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        >
          <CanvasRevealEffect
            ...
            colors={[
              ...
              [168, 85, 247], // Slightly darker purple for gradient effect
            ]}
            dotSize={2}
          />
        </Card>
        <Card
          ...
          description="Here, I begin developing the project, following the plan closely while keeping detailed documentation. This ensures that every step is tracked and can be easily referenced or adjusted later."
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black"
            colors={[
              [255, 99, 71], // Lighter red (more vibrant)
              [183, 28, 28], // Darker red (deep, dark red for contrast)
            ]}
            dotSize={2}
          />
        </Card>
        <Card
          ...
          description="In the final phase, I bring the project to life by testing, finalizing, and deploying the solution. I ensure everything runs smoothly and meets the project goals before launch."
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-black" // Darker background for pink theme
            colors={[
              [249, 168, 212], // Lighter pink accent
              [236, 72, 153], // Slightly darker pink for gradient effect
            ]}
            dotSize={2}
          />
        </Card>
...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center dark:border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3"
    >
